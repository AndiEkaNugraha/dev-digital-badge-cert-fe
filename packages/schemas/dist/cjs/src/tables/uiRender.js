...
const uiRender = async (arg) => {
    ...
    if (mode === 'form' && onChange && !schema.readOnly) {
        ...
        table.body.forEach((row, i) => {
            ...
            removeRowButton.style.top = `${offsetY - (0, common_1.px2mm)(30)}mm`;
    ...
    if (mode === 'designer' && onChange) {
        ...
        addColumnButton.style.top = `${table.getHeadHeight() - (0, common_1.px2mm)(30)}mm`;
        ...
        table.columns.forEach((column, i) => {
            ...
            removeColumnButton.style.left = `${offsetX - (0, common_1.px2mm)(30)}mm`;
