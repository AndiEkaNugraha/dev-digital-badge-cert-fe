...
import { checkGenerateProps, getDynamicTemplate } from '../../../../common/dist/esm/src';
import { modifyTemplateForTable, getDynamicHeightForTable } from '../../../../schemas/dist/esm/src';
...
const generate = async (props) => {
    ...
    if (inputs.length === 0) {
        throw new Error('[generator] inputs should not be empty, pass at least an empty object in the array');
    }
